...
const VehicleDetail: React.FC = () => {
  ...
  const safeMaintenanceServices = Array.isArray(maintenanceServices) ? maintenanceServices : [];
  const safeMaintenanceReminders = Array.isArray(maintenanceReminders) ? maintenanceReminders : [];
    ...
    <div className="animate-fade-in">
              ...
              <div>
                ...
                <p className="font-medium">
                  {selectedVehicle.fuelType === 'gasoline'
                    ? 'Gasolina'
                    : selectedVehicle.fuelType === 'ethanol'
                    ? 'Etanol'
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-accent-900">
                        {vehicleStats.upcomingMaintenance}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-secondary-900">
                        R$ {vehicleStats.totalExpenses.toLocaleString('pt-BR', {
      ...
      {activeTab === 'overview' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="card">
            ...
            <RemindersList
              reminders={safeMaintenanceReminders.slice(0, 3)}
          ...
          <div className="card">
            ...
            <MaintenanceTimeline services={safeMaintenanceServices.slice(0, 3)} />
          </div>
      ...
      {activeTab === 'maintenance' && (
        <div>
          ...
          <div className="card">
            <MaintenanceTimeline services={safeMaintenanceServices} />
          </div>
        </div>
      )}
      ...
      {activeTab === 'reminders' && (
        <div>
          ...
          <div className="card">
            <RemindersList
              reminders={safeMaintenanceReminders}
              onComplete={completeReminder}
            />
          </div>
        </div>
