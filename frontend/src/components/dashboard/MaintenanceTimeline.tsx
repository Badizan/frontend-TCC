      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center pb-4 border-b space-y-4 sm:space-y-0">
        ...
        {validServices.length > 5 && (
          <button
            ...
            className="flex items-center justify-center space-x-2 px-3 sm:px-4 py-2 text-sm font-medium text-blue-600 hover:text-blue-800 border border-blue-200 rounded-lg hover:bg-blue-50 transition-colors w-full sm:w-auto"
          >
                  ...
                  <div className="flex items-start space-x-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-2 mb-2 space-y-1 sm:space-y-0">
                        ...
                        <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${getTypeColor(safeService.type)} self-start sm:self-auto`}>
